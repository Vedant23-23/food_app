...
import 'package:flutter_e_commerce_shop_app/base/common_text_button.dart';
...
import 'package:flutter_e_commerce_shop_app/base/no_data_found.dart';
...
import 'package:flutter_e_commerce_shop_app/models/cart_item.dart';
...
import 'package:flutter_e_commerce_shop_app/screens/checkout/payment_option_button.dart';
      ...
      body:Stack(
        children: [
          ...
          GetBuilder<CartController>(builder: (_){
            var myCartObj = Get.find<CartController>();
                    ...
                    return  MediaQuery.removePadding(
                      ...
                      child: SingleChildScrollView(
                        child: ListView.builder(
                            shrinkWrap: true, // Added to prevent ListView from taking infinite height
                                  ...
                                  children: [
                                    GestureDetector(
                                      onTap: (){
                                        ...
                                        // page = "recommended";
                                        if(getPageIndex<0){
                                          getPageIndex=Get.find<ProductController>().popularProductList.indexOf(_cartList[index].product);
                                          // page="popular";
                                        }
                                        if(getPageIndex<0){
      ...
      bottomNavigationBar: GetBuilder<OrderController>(builder: (orderController){
         _noteController.text= orderController.foodNote??"";
          return !orderController.isLoading? Container(
            ...
            height: Dimensions.buttonButtonCon+55,
            padding:
