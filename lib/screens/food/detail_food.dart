...
import 'package:flutter_e_commerce_shop_app/components/expanded_widget.dart';
...
class DetailFood extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(page=="recommended"){
       productItem = Get.find<ProductController>().popularProductList[pageId];
      Get.find<ProductController>().initData(productItem, pageId, Get.find<CartController>());
    }else{
       productItem = Get.find<ProductController>().extraProductList[pageId];
      Get.find<ProductController>().initData(productItem, pageId, Get.find<CartController>());
    }
        ...
        children: [
          Positioned(
              ...
              child: CachedNetworkImage(
                imageUrl:   AppConstants.UPLOADS_URL+productItem.img,
                ...
                errorWidget: (context, url, error) => Image.asset("assets/image/icon.png"),
